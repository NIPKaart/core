...
3. As an administrator, open **Municipal imports** (shown as **Gemeentelijke imports** in the Dutch interface). Enable publication for the connected source before publishing its first delivery. Configuration changes invalidate earlier reviews; retrieve a new delivery afterwards.
